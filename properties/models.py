...
class Property(AbstractDate):
    ...
    property_type = models.CharField(max_length=15,
        default=PropertyType.HOME, choices=PropertyType.choices         
    )
...
class Unit(AbstractDate):
    ...
    property_reference = models.ForeignKey(Property, related_name="property_units",on_delete=models.CASCADE)
    unit_type=models.CharField(max_length=7,default=UnitType.ONEBHK,choices=UnitType.choices)
